...
tarch::logging::Log peanoclaw::GhostLayerCompositor::_log("peanoclaw::GhostLayerCompositor");

void peanoclaw::GhostLayerCompositor::interpolate(
...
void peanoclaw::GhostLayerCompositor::copyGhostLayerDataBlock(
...
peanoclaw::GhostLayerCompositor::GhostLayerCompositor(
...
void peanoclaw::GhostLayerCompositor::fillLeftGhostLayer() {
...
void peanoclaw::GhostLayerCompositor::fillLowerLeftGhostLayer() {
  int ghostLayerWidth = _patches[0].getGhostLayerWidth();
...
void peanoclaw::GhostLayerCompositor::fillLowerGhostLayer() {
  int ghostLayerWidth = _patches[0].getGhostLayerWidth();
  tarch::la::Vector<DIMENSIONS, int> subdivisionFactor = _patches[0].getSubdivisionFactor();
...
void peanoclaw::GhostLayerCompositor::fillUpperLeftGhostLayer() {
...
void peanoclaw::GhostLayerCompositor::fillUpperGhostLayer() {
  int ghostLayerWidth = _patches[2].getGhostLayerWidth();
  tarch::la::Vector<DIMENSIONS, int> subdivisionFactor = _patches[2].getSubdivisionFactor();
  tarch::la::Vector<DIMENSIONS, int> rowSize;
  rowSize(0) = subdivisionFactor(0);
...
void peanoclaw::GhostLayerCompositor::fillUpperRightGhostLayer() {
...
void peanoclaw::GhostLayerCompositor::fillRightGhostLayer() {
  int ghostLayerWidth = _patches[3].getGhostLayerWidth();
  tarch::la::Vector<DIMENSIONS, int> subdivisionFactor = _patches[3].getSubdivisionFactor();
  tarch::la::Vector<DIMENSIONS, int> columnSize;
  columnSize(0) = ghostLayerWidth;
...
void peanoclaw::GhostLayerCompositor::fillLowerRightGhostLayer() {
...
double peanoclaw::GhostLayerCompositor::calculateOverlappingArea(
...
void peanoclaw::GhostLayerCompositor::updateLowerGhostlayerBound(
...
void peanoclaw::GhostLayerCompositor::updateUpperGhostlayerBound(
  int updatedPatchIndex,
  int neighborPatchIndex,
  int dimension
) {
...
void peanoclaw::GhostLayerCompositor::applyCoarseGridCorrection(
...
void peanoclaw::GhostLayerCompositor::updateNeighborTime(int updatedPatchIndex, int neighborPatchIndex) {
...
void peanoclaw::GhostLayerCompositor::fillGhostLayers(int destinationPatchIndex) {
...
void peanoclaw::GhostLayerCompositor::updateNeighborTimes() {
  //Check cell 0 and 1
...
void peanoclaw::GhostLayerCompositor::updateGhostlayerBounds() {
...
bool peanoclaw::GhostLayerCompositor::shouldTransferGhostlayerData(Patch& source, Patch& destination) {
