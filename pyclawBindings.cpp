...
peanoclaw::runners::PeanoClawLibraryRunner* pyclaw_peano_new (
  ...
  peanoclaw::PyClaw *pyClaw = new peanoclaw::PyClaw(initializationCallback, boundaryConditionCallback, solverCallback, 0);
...
void pyclaw_peano_evolveToTime(
  ...
  peanoclaw::PyClaw pyClaw(0, boundaryConditionCallback, solverCallback, 0);
...
void pyclaw_peano_gatherSolution(
  ...
  peanoclaw::PyClaw pyClaw(0, 0, 0, addPatchToSolutionCallback);
