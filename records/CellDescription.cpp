...
_skipNextGridIteration(skipNextGridIteration),
...
bool peanoclaw::records::CellDescription::PersistentRecords::getSkipNextGridIteration() const {
   return _skipNextGridIteration;
}



void peanoclaw::records::CellDescription::PersistentRecords::setSkipNextGridIteration(const bool& skipNextGridIteration) {
   _skipNextGridIteration = skipNextGridIteration;
}
...
_persistentRecords(persistentRecords._subdivisionFactor, persistentRecords._ghostLayerWidth, persistentRecords._unknownsPerSubcell, persistentRecords._auxiliarFieldsPerSubcell, persistentRecords._level, persistentRecords._isVirtual, persistentRecords._position, persistentRecords._size, persistentRecords._time, persistentRecords._timestepSize, persistentRecords._maximumFineGridTime, persistentRecords._minimumFineGridTimestep, persistentRecords._synchronizeFineGrids, persistentRecords._willCoarsen, persistentRecords._minimalNeighborTimeConstraint, persistentRecords._minimalLeafNeighborTimeConstraint, persistentRecords._minimalNeighborTime, persistentRecords._maximalNeighborTimestep, persistentRecords._estimatedNextTimestepSize, persistentRecords._skipNextGridIteration, persistentRecords._ageInGridIterations, persistentRecords._demandedMeshWidth, persistentRecords._restrictionLowerBounds, persistentRecords._restrictionUpperBounds, persistentRecords._cellDescriptionIndex, persistentRecords._uOldIndex, persistentRecords._uNewIndex, persistentRecords._auxIndex) {
   
}


peanoclaw::records::CellDescription::CellDescription(const tarch::la::Vector<DIMENSIONS,int>& subdivisionFactor, const int& ghostLayerWidth, const int& unknownsPerSubcell, const int& auxiliarFieldsPerSubcell, const int& level, const bool& isVirtual, const tarch::la::Vector<DIMENSIONS,double>& position, const tarch::la::Vector<DIMENSIONS,double>& size, const double& time, const double& timestepSize, const double& maximumFineGridTime, const double& minimumFineGridTimestep, const bool& synchronizeFineGrids, const bool& willCoarsen, const double& minimalNeighborTimeConstraint, const double& minimalLeafNeighborTimeConstraint, const double& minimalNeighborTime, const double& maximalNeighborTimestep, const double& estimatedNextTimestepSize, const bool& skipNextGridIteration, const int& ageInGridIterations, const double& demandedMeshWidth, const tarch::la::Vector<DIMENSIONS,double>& restrictionLowerBounds, const tarch::la::Vector<DIMENSIONS,double>& restrictionUpperBounds, const int& cellDescriptionIndex, const int& uOldIndex, const int& uNewIndex, const int& auxIndex):
_persistentRecords(subdivisionFactor, ghostLayerWidth, unknownsPerSubcell, auxiliarFieldsPerSubcell, level, isVirtual, position, size, time, timestepSize, maximumFineGridTime, minimumFineGridTimestep, synchronizeFineGrids, willCoarsen, minimalNeighborTimeConstraint, minimalLeafNeighborTimeConstraint, minimalNeighborTime, maximalNeighborTimestep, estimatedNextTimestepSize, skipNextGridIteration, ageInGridIterations, demandedMeshWidth, restrictionLowerBounds, restrictionUpperBounds, cellDescriptionIndex, uOldIndex, uNewIndex, auxIndex) {
...
bool peanoclaw::records::CellDescription::getSkipNextGridIteration() const {
   return _persistentRecords._skipNextGridIteration;
}



void peanoclaw::records::CellDescription::setSkipNextGridIteration(const bool& skipNextGridIteration) {
   _persistentRecords._skipNextGridIteration = skipNextGridIteration;
}
...
void peanoclaw::records::CellDescription::toString (std::ostream& out) const {
   ...
   out << ",";
   out << "skipNextGridIteration:" << getSkipNextGridIteration();
   out << ",";
...
peanoclaw::records::CellDescriptionPacked peanoclaw::records::CellDescription::convert() const{
   ...
   void peanoclaw::records::CellDescription::initDatatype() {
      ...
      MPI_Datatype subtypes[Attributes] = {
         ...
         MPI_CHAR,		 //skipNextGridIteration
      ...
      MPI_Address( const_cast<void*>(static_cast<const void*>(&(dummyCellDescription[0]._persistentRecords._skipNextGridIteration))), 		&disp[19] );
      ...
      MPI_Address( const_cast<void*>(static_cast<const void*>(&(dummyCellDescription[0]._persistentRecords._uOldIndex))), 		&disp[25] );
      MPI_Address( const_cast<void*>(static_cast<const void*>(&(dummyCellDescription[0]._persistentRecords._uNewIndex))), 		&disp[26] );
      MPI_Address( const_cast<void*>(static_cast<const void*>(&(dummyCellDescription[0]._persistentRecords._auxIndex))), 		&disp[27] );
   ...
   void peanoclaw::records::CellDescription::send(int destination, int tag) {
   ...
   void peanoclaw::records::CellDescription::receive(int source, int tag) {
      MPI_Request* sendRequestHandle = new MPI_Request();
      MPI_Status   status;
      int          flag = 0;
      int          result;
   ...
   bool peanoclaw::records::CellDescription::isMessageInQueue(int tag) {
      MPI_Status status;
      int  flag        = 0;
      MPI_Iprobe(
         MPI_ANY_SOURCE, tag,
   ...
   int peanoclaw::records::CellDescription::getSenderRank() const {
...
bool peanoclaw::records::CellDescriptionPacked::PersistentRecords::getSkipNextGridIteration() const {
   return _skipNextGridIteration;
}



void peanoclaw::records::CellDescriptionPacked::PersistentRecords::setSkipNextGridIteration(const bool& skipNextGridIteration) {
   _skipNextGridIteration = skipNextGridIteration;
}
...
bool peanoclaw::records::CellDescriptionPacked::getSkipNextGridIteration() const {
   return _persistentRecords._skipNextGridIteration;
}



void peanoclaw::records::CellDescriptionPacked::setSkipNextGridIteration(const bool& skipNextGridIteration) {
   _persistentRecords._skipNextGridIteration = skipNextGridIteration;
}
...
peanoclaw::records::CellDescription peanoclaw::records::CellDescriptionPacked::convert() const{
   ...
   void peanoclaw::records::CellDescriptionPacked::initDatatype() {
      ...
      MPI_Address( const_cast<void*>(static_cast<const void*>(&(dummyCellDescriptionPacked[0]._persistentRecords._skipNextGridIteration))), 		&disp[19] );
      ...
      MPI_Address( const_cast<void*>(static_cast<const void*>(&(dummyCellDescriptionPacked[0]._persistentRecords._uOldIndex))), 		&disp[25] );
      MPI_Address( const_cast<void*>(static_cast<const void*>(&(dummyCellDescriptionPacked[0]._persistentRecords._uNewIndex))), 		&disp[26] );
      MPI_Address( const_cast<void*>(static_cast<const void*>(&(dummyCellDescriptionPacked[0]._persistentRecords._auxIndex))), 		&disp[27] );
   ...
   void peanoclaw::records::CellDescriptionPacked::send(int destination, int tag) {
      MPI_Request* sendRequestHandle = new MPI_Request();
      MPI_Status   status;
      int          flag = 0;
      int          result;
   ...
   void peanoclaw::records::CellDescriptionPacked::receive(int source, int tag) {
      MPI_Request* sendRequestHandle = new MPI_Request();
      MPI_Status   status;
      int          flag = 0;
      int          result;
   ...
   bool peanoclaw::records::CellDescriptionPacked::isMessageInQueue(int tag) {
      MPI_Status status;
      int  flag        = 0;
      MPI_Iprobe(
         MPI_ANY_SOURCE, tag,
   ...
   int peanoclaw::records::CellDescriptionPacked::getSenderRank() const {
      assertion( _senderRank!=-1 );
      return _senderRank;
