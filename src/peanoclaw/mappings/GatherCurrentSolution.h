...
#ifndef PEANOCLAW_MAPPINGS_GatherCurrentSolution_H_
#define PEANOCLAW_MAPPINGS_GatherCurrentSolution_H_
 ...
 */
class peanoclaw::mappings::GatherCurrentSolution {
  private:
    /**
