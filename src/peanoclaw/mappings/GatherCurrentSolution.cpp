...
tarch::logging::Log                peanoclaw::mappings::GatherCurrentSolution::_log( "peanoclaw::mappings::GatherCurrentSolution" ); 


peanoclaw::mappings::GatherCurrentSolution::GatherCurrentSolution() {
...
void peanoclaw::mappings::GatherCurrentSolution::mergeWithWorkerThread(const GatherCurrentSolution& workerThread) {
  logTraceIn( "mergeWithWorkerThread(GatherCurrentSolution)" );
  // @todo Insert your code here
  logTraceOut( "mergeWithWorkerThread(GatherCurrentSolution)" );
}
#endif


void peanoclaw::mappings::GatherCurrentSolution::createHangingVertex(
...
void peanoclaw::mappings::GatherCurrentSolution::destroyHangingVertex(
...
void peanoclaw::mappings::GatherCurrentSolution::createInnerVertex(
      peanoclaw::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peanoclaw::Vertex * const        coarseGridVertices,
...
void peanoclaw::mappings::GatherCurrentSolution::createBoundaryVertex(
      peanoclaw::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peanoclaw::Vertex * const        coarseGridVertices,
...
void peanoclaw::mappings::GatherCurrentSolution::destroyVertex(
      const peanoclaw::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      peanoclaw::Vertex * const  coarseGridVertices,
...
void peanoclaw::mappings::GatherCurrentSolution::createCell(
...
void peanoclaw::mappings::GatherCurrentSolution::destroyCell(
...
#ifdef Parallel
void peanoclaw::mappings::GatherCurrentSolution::mergeWithNeighbour(
...
void peanoclaw::mappings::GatherCurrentSolution::prepareSendToNeighbour(
  peanoclaw::Vertex&  vertex,
  int  toRank,
  int  level
) {
...
void peanoclaw::mappings::GatherCurrentSolution::prepareCopyToRemoteNode(
...
void peanoclaw::mappings::GatherCurrentSolution::mergeWithRemoteDataDueToForkOrJoin(
  peanoclaw::Vertex&  localVertex,
...
void peanoclaw::mappings::GatherCurrentSolution::prepareSendToWorker(
  peanoclaw::Cell&                 fineGridCell,
  peanoclaw::Vertex * const        fineGridVertices,
  const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
  peanoclaw::Vertex * const        coarseGridVertices,
...
void peanoclaw::mappings::GatherCurrentSolution::mergeWithMaster(
...
void peanoclaw::mappings::GatherCurrentSolution::receiveDataFromMaster(
...
void peanoclaw::mappings::GatherCurrentSolution::mergeWithWorker(
  peanoclaw::Cell&           localCell, 
...
void peanoclaw::mappings::GatherCurrentSolution::touchVertexFirstTime(
      peanoclaw::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peanoclaw::Vertex * const        coarseGridVertices,
...
void peanoclaw::mappings::GatherCurrentSolution::touchVertexLastTime(
      peanoclaw::Vertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      peanoclaw::Vertex * const  coarseGridVertices,
...
void peanoclaw::mappings::GatherCurrentSolution::enterCell(
      peanoclaw::Cell&                 fineGridCell,
      peanoclaw::Vertex * const        fineGridVertices,
      const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
      peanoclaw::Vertex * const        coarseGridVertices,
...
void peanoclaw::mappings::GatherCurrentSolution::leaveCell(
      peanoclaw::Cell&           fineGridCell,
      peanoclaw::Vertex * const  fineGridVertices,
      const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
      peanoclaw::Vertex * const  coarseGridVertices,
...
void peanoclaw::mappings::GatherCurrentSolution::beginIteration(
...
void peanoclaw::mappings::GatherCurrentSolution::endIteration(
  peanoclaw::State&  solverState
) {
...
void peanoclaw::mappings::GatherCurrentSolution::descend(
...
void peanoclaw::mappings::GatherCurrentSolution::ascend(
  peanoclaw::Cell * const    fineGridCells,
  peanoclaw::Vertex * const  fineGridVertices,
  const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
  peanoclaw::Vertex * const  coarseGridVertices,
