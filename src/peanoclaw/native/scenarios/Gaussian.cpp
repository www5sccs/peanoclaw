...
void peanoclaw::native::scenarios::GaussianSWEScenario::initializePatch(peanoclaw::Patch& patch) {
...
tarch::la::Vector<DIMENSIONS,double> peanoclaw::native::scenarios::GaussianSWEScenario::computeDemandedMeshWidth(
...
tarch::la::Vector<DIMENSIONS,double> peanoclaw::native::scenarios::GaussianSWEScenario::getDomainOffset() const {
  return _domainOffset;
}

tarch::la::Vector<DIMENSIONS,double> peanoclaw::native::scenarios::GaussianSWEScenario::getDomainSize() const {
  return _domainSize;
}

tarch::la::Vector<DIMENSIONS,double> peanoclaw::native::scenarios::GaussianSWEScenario::getInitialMinimalMeshWidth() const {
  return _maximalMeshWidth;
}

tarch::la::Vector<DIMENSIONS,int> peanoclaw::native::scenarios::GaussianSWEScenario::getSubdivisionFactor() const {
  return _subdivisionFactor;
}

double peanoclaw::native::scenarios::GaussianSWEScenario::getGlobalTimestepSize() const {
  return _globalTimestepSize;
}

double peanoclaw::native::scenarios::GaussianSWEScenario::getEndTime() const {
  return _endTime;
}

float peanoclaw::native::scenarios::GaussianSWEScenario::getWaterHeight(float x, float y) {
  // center coordinates
