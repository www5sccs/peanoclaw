...
void SWE_WavePropagationBlock_patch::setArrays(
  ...
  this->h = Float2D(
              subgrid.getSubdivisionFactor()(0) + subgrid.getGhostlayerWidth()*2,
              subgrid.getSubdivisionFactor()(1) + subgrid.getGhostlayerWidth()*2,
              h
            );
  this->hu = Float2D(
              subgrid.getSubdivisionFactor()(0) + subgrid.getGhostlayerWidth()*2,
