...
#ifndef PEANOCLAW_INTERSUBGRIDCOMMUNICATION_ASPECTS_FACEADJACENTPATCHTRAVERSAL_H_
#define PEANOCLAW_INTERSUBGRIDCOMMUNICATION_ASPECTS_FACEADJACENTPATCHTRAVERSAL_H_
...
namespace peanoclaw {
  namespace interSubgridCommunication {
    namespace aspects {
      ...
      class FaceAdjacentPatchTraversal;
    }
  }
}
 ...
 */
template<class LoopBody>
class peanoclaw::interSubgridCommunication::aspects::FaceAdjacentPatchTraversal {

  public:
    FaceAdjacentPatchTraversal(
      peanoclaw::Patch patches[TWO_POWER_D],
      LoopBody& loopBody
    );
};

#include "peanoclaw/interSubgridCommunication/aspects/FaceAdjacentPatchTraversal.cpph"

#endif /* PEANOCLAW_INTERSUBGRIDCOMMUNICATION_ASPECTS_FACEADJACENTPATCHTRAVERSAL_H_ */
