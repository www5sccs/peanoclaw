...
#ifndef PEANOCLAW_ADAPTERS_InitialiseAndValidateGrid_H_
#define PEANOCLAW_ADAPTERS_InitialiseAndValidateGrid_H_
...
namespace peanoclaw {
      namespace adapters {
        class InitialiseAndValidateGrid;
      } 
}
 ...
 */
class peanoclaw::adapters::InitialiseAndValidateGrid {
  private:
    peanoclaw::mappings::Remesh _map2Remesh;
    peanoclaw::mappings::InitialiseGrid _map2InitialiseGrid;
  ...
  public:
    ...
    InitialiseAndValidateGrid();

    #if defined(SharedMemoryParallelisation)
    InitialiseAndValidateGrid(const InitialiseAndValidateGrid& masterThread);
    #endif

    virtual ~InitialiseAndValidateGrid();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const InitialiseAndValidateGrid& workerThread);
    #endif
