...
#ifndef PEANOCLAW_ADAPTERS_SolveTimestepAndPlotAndValidateGrid_H_
#define PEANOCLAW_ADAPTERS_SolveTimestepAndPlotAndValidateGrid_H_
...
namespace peanoclaw {
      namespace adapters {
        class SolveTimestepAndPlotAndValidateGrid;
      } 
}
 ...
 */
class peanoclaw::adapters::SolveTimestepAndPlotAndValidateGrid {
  private:
  ...
  public:
    ...
    SolveTimestepAndPlotAndValidateGrid(const SolveTimestepAndPlotAndValidateGrid& masterThread);
    #endif

    virtual ~SolveTimestepAndPlotAndValidateGrid();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const SolveTimestepAndPlotAndValidateGrid& workerThread);
    #endif
