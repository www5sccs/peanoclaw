...
peano::MappingSpecification   peanoclaw::adapters::PlotAndValidateGrid::touchVertexLastTimeSpecification() {
...
peano::MappingSpecification   peanoclaw::adapters::PlotAndValidateGrid::touchVertexFirstTimeSpecification() { 
  return peano::MappingSpecification::getMostGeneralSpecification()
...
peano::MappingSpecification   peanoclaw::adapters::PlotAndValidateGrid::enterCellSpecification() {
  return peano::MappingSpecification::getMostGeneralSpecification()
...
peano::MappingSpecification   peanoclaw::adapters::PlotAndValidateGrid::leaveCellSpecification() {
  return peano::MappingSpecification::getMostGeneralSpecification()
...
peano::MappingSpecification   peanoclaw::adapters::PlotAndValidateGrid::ascendSpecification() {
  return peano::MappingSpecification::getMostGeneralSpecification()
...
peano::MappingSpecification   peanoclaw::adapters::PlotAndValidateGrid::descendSpecification() {
  return peano::MappingSpecification::getMostGeneralSpecification()
...
peanoclaw::adapters::PlotAndValidateGrid::PlotAndValidateGrid() {
}
...
peanoclaw::adapters::PlotAndValidateGrid::PlotAndValidateGrid(const PlotAndValidateGrid&  masterThread):
...
void peanoclaw::adapters::PlotAndValidateGrid::mergeWithWorkerThread(const PlotAndValidateGrid& workerThread) {
...
void peanoclaw::adapters::PlotAndValidateGrid::createHangingVertex(
...
void peanoclaw::adapters::PlotAndValidateGrid::destroyHangingVertex(
...
void peanoclaw::adapters::PlotAndValidateGrid::createInnerVertex(
      peanoclaw::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peanoclaw::Vertex * const        coarseGridVertices,
...
void peanoclaw::adapters::PlotAndValidateGrid::createBoundaryVertex(
      peanoclaw::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peanoclaw::Vertex * const        coarseGridVertices,
...
void peanoclaw::adapters::PlotAndValidateGrid::destroyVertex(
      const peanoclaw::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      peanoclaw::Vertex * const  coarseGridVertices,
...
void peanoclaw::adapters::PlotAndValidateGrid::createCell(
...
void peanoclaw::adapters::PlotAndValidateGrid::destroyCell(
...
#ifdef Parallel
void peanoclaw::adapters::PlotAndValidateGrid::mergeWithNeighbour(
...
void peanoclaw::adapters::PlotAndValidateGrid::prepareSendToNeighbour(
  peanoclaw::Vertex&  vertex,
  int                                           toRank,
...
void peanoclaw::adapters::PlotAndValidateGrid::prepareCopyToRemoteNode(
...
void peanoclaw::adapters::PlotAndValidateGrid::mergeWithRemoteDataDueToForkOrJoin(
  peanoclaw::Vertex&  localVertex,
...
bool peanoclaw::adapters::PlotAndValidateGrid::prepareSendToWorker(
  peanoclaw::Cell&                 fineGridCell,
  peanoclaw::Vertex * const        fineGridVertices,
  const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
  peanoclaw::Vertex * const        coarseGridVertices,
...
void peanoclaw::adapters::PlotAndValidateGrid::prepareSendToMaster(
  peanoclaw::Cell&                       localCell,
...
void peanoclaw::adapters::PlotAndValidateGrid::mergeWithMaster(
...
void peanoclaw::adapters::PlotAndValidateGrid::receiveDataFromMaster(
...
void peanoclaw::adapters::PlotAndValidateGrid::mergeWithWorker(
  peanoclaw::Cell&           localCell, 
...
void peanoclaw::adapters::PlotAndValidateGrid::touchVertexFirstTime(
      peanoclaw::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      peanoclaw::Vertex * const        coarseGridVertices,
...
void peanoclaw::adapters::PlotAndValidateGrid::touchVertexLastTime(
      peanoclaw::Vertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      peanoclaw::Vertex * const  coarseGridVertices,
...
void peanoclaw::adapters::PlotAndValidateGrid::enterCell(
      peanoclaw::Cell&                 fineGridCell,
      peanoclaw::Vertex * const        fineGridVertices,
      const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
      peanoclaw::Vertex * const        coarseGridVertices,
...
void peanoclaw::adapters::PlotAndValidateGrid::leaveCell(
      peanoclaw::Cell&           fineGridCell,
      peanoclaw::Vertex * const  fineGridVertices,
      const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
      peanoclaw::Vertex * const  coarseGridVertices,
...
void peanoclaw::adapters::PlotAndValidateGrid::beginIteration(
...
void peanoclaw::adapters::PlotAndValidateGrid::endIteration(
  peanoclaw::State&  solverState
) {
...
void peanoclaw::adapters::PlotAndValidateGrid::descend(
...
void peanoclaw::adapters::PlotAndValidateGrid::ascend(
  peanoclaw::Cell * const    fineGridCells,
  peanoclaw::Vertex * const  fineGridVertices,
  const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
  peanoclaw::Vertex * const  coarseGridVertices,
