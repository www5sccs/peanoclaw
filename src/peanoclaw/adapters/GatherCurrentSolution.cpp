...
void peanoclaw::adapters::GatherCurrentSolution::prepareSendToNeighbour(
  ...
  int  level
   ...
   _map2GatherCurrentSolution.prepareSendToNeighbour( vertex, toRank, level );
...
void peanoclaw::adapters::GatherCurrentSolution::prepareCopyToRemoteNode(
  ...
  int  toRank
   ...
   _map2GatherCurrentSolution.prepareCopyToRemoteNode( localVertex, toRank );
...
void peanoclaw::adapters::GatherCurrentSolution::prepareCopyToRemoteNode(
  ...
  int  toRank
   ...
   _map2GatherCurrentSolution.prepareCopyToRemoteNode( localCell, toRank );
...
void peanoclaw::adapters::GatherCurrentSolution::prepareSendToMaster(
  ...
  const peano::grid::VertexEnumerator&  verticesEnumerator
   ...
   _map2GatherCurrentSolution.prepareSendToMaster( localCell, vertices, verticesEnumerator );
...
void peanoclaw::adapters::GatherCurrentSolution::receiveDataFromMaster(
  ...
  const peano::grid::VertexEnumerator&    verticesEnumerator
   ...
   _map2GatherCurrentSolution.receiveDataFromMaster( receivedCell, receivedVertices, verticesEnumerator );
...
void peanoclaw::adapters::GatherCurrentSolution::mergeWithWorker(
  ...
  const peanoclaw::Cell&     receivedMasterCell
   ...
   _map2GatherCurrentSolution.mergeWithWorker( localCell, receivedMasterCell );
...
void peanoclaw::adapters::GatherCurrentSolution::mergeWithWorker(
  ...
  const peanoclaw::Vertex&  receivedMasterVertex
   ...
   _map2GatherCurrentSolution.mergeWithWorker( localVertex, receivedMasterVertex );
