...
#ifndef PEANOCLAW_ADAPTERS_SolveTimestep_H_
#define PEANOCLAW_ADAPTERS_SolveTimestep_H_
 ...
 */
class peanoclaw::adapters::SolveTimestep {
  private:
  ...
  public:
    ...
    SolveTimestep(const SolveTimestep& masterThread);
    #endif

    virtual ~SolveTimestep();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const SolveTimestep& workerThread);
    #endif
