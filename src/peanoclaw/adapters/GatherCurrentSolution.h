...
#ifndef PEANOCLAW_ADAPTERS_GatherCurrentSolution_H_
#define PEANOCLAW_ADAPTERS_GatherCurrentSolution_H_
 ...
 */
class peanoclaw::adapters::GatherCurrentSolution {
  private:
  ...
  public:
    ...
    GatherCurrentSolution();

    #if defined(SharedMemoryParallelisation)
    GatherCurrentSolution(const GatherCurrentSolution& masterThread);
    #endif

    virtual ~GatherCurrentSolution();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const GatherCurrentSolution& workerThread);
    #endif
