...
#ifndef PEANOCLAW_ADAPTERS_GatherCurrentSolutionAndValidateGrid_H_
#define PEANOCLAW_ADAPTERS_GatherCurrentSolutionAndValidateGrid_H_
...
namespace peanoclaw {
      namespace adapters {
        class GatherCurrentSolutionAndValidateGrid;
      } 
}
 ...
 */
class peanoclaw::adapters::GatherCurrentSolutionAndValidateGrid {
  private:
    peanoclaw::mappings::Remesh _map2Remesh;
    peanoclaw::mappings::GatherCurrentSolution _map2GatherCurrentSolution;
  ...
  public:
    ...
    GatherCurrentSolutionAndValidateGrid();

    #if defined(SharedMemoryParallelisation)
    GatherCurrentSolutionAndValidateGrid(const GatherCurrentSolutionAndValidateGrid& masterThread);
    #endif

    virtual ~GatherCurrentSolutionAndValidateGrid();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const GatherCurrentSolutionAndValidateGrid& workerThread);
    #endif
