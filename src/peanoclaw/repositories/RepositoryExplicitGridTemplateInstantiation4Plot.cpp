...
namespace peano {
  namespace grid {
    template class Grid<peanoclaw::Vertex,peanoclaw::Cell,peanoclaw::State, peano::stacks::VertexArrayStack<peanoclaw::Vertex> ,peano::stacks::CellArrayStack<peanoclaw::Cell> ,peanoclaw::adapters::Plot>;
    template class Grid<peanoclaw::Vertex,peanoclaw::Cell,peanoclaw::State, peano::stacks::VertexSTDStack<  peanoclaw::Vertex> ,peano::stacks::CellSTDStack<  peanoclaw::Cell> ,peanoclaw::adapters::Plot>;
  }
}
