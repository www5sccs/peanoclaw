      ...
      void peanoclaw::records::State::initDatatype() {
         {
            ...
            MPI_Address( const_cast<void*>(static_cast<const void*>(&(dummyState[1]._persistentRecords._isInitializing))), 		&disp[47] );
