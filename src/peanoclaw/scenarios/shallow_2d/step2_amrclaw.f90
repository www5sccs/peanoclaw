subroutine step2(maxm,maxmx,maxmy,meqn,mwaves,maux,mbc,mx,my,mcapa,method,mthlim,qold,aux,dx,dy,dt,cflgrid,fm,fp,gm,gp,rpn2,rpt2)
!
...
!
    ...
    ! Arguments
    integer, intent(in) ::  maxm,maxmx,maxmy,meqn,mwaves,maux,mbc,mx,my,mcapa,method(7)
    real(kind=8), intent(in) :: dx,dy,dt,mthlim(mwaves)
    ...
    do j = 0,my+1
        ...
        call flux2(1,maxm,meqn,mwaves,maux,mbc,mx,method,mthlim,q1d,dtdx1d,aux1,aux2,aux3, &
    ...
    do i = 0,mx+1
        ...
        ! Compute modifications fadd and gadd to fluxes along this slice
        call flux2(2,maxm,meqn,mwaves,maux,mbc,my,method,mthlim,q1d,dtdy1d,aux1,aux2,aux3, &
