...
class Solver(Solver):
    ...
    def get_solver_callback(self):
        ...
        def callback_solver(return_dt_and_estimated_next_dt, q, qbc, aux, subdivision_factor_x0, subdivision_factor_x1, subdivision_factor_x2, unknowns_per_cell, aux_fields_per_cell, size_x, size_y, size_z, position_x, position_y, position_z, current_time, maximum_timestep_size, estimated_next_dt, use_dim_splitting):
            ...
            subgridsolver = peanoclaw.SubgridSolver(self.solver, self.solution.state, q, qbc, aux, (position_x, position_y,position_z), (size_x, size_y,size_z), subdivision_factor_x0, subdivision_factor_x1, subdivision_factor_x2, unknowns_per_cell, aux_fields_per_cell, current_time)
