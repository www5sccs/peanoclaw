...
#include "EulerEquations/RoeSolver.hpp"
...
void peanoclaw::solver::euler3d::Euler3DKernel::solveTimestep(Patch& subgrid, double maximumTimestepSize, bool useDimensionalSplitting) {
  #ifdef Dim3
...
double peanoclaw::solver::euler3d::Euler3DKernel::computeTimestep(
  ...
  EulerEquations::RoeSolver solver;
...
//        peanoclaw::solver::euler3d::Cell& rightCell = cellsUOld[linearUOldIndex+xyPlane];
        ...
        if(plot) {
          ...
          std::cout << "right: density=" << rightCell.density() << ", momentum=" << rightCell.velocity()(0) << "," << rightCell.velocity()(1) << "," << rightCell.velocity()(2) << ", energy=" << rightCell.energy() << std::endl;
          std::cout << "bottom: density=" << bottomCell.density() << ", momentum=" << bottomCell.velocity()(0) << "," << bottomCell.velocity()(1) << "," << bottomCell.velocity()(2) << ", energy=" << bottomCell.energy() << std::endl;
          std::cout << "top: density=" << topCell.density() << ", " << topCell.velocity()(0) << "," << topCell.velocity()(1) << "," << topCell.velocity()(2) << ", energy=" << topCell.energy() << std::endl;
          std::cout << "back: density=" << backCell.density() << ", momentum=" << backCell.velocity()(0) << "," << backCell.velocity()(1) << "," << backCell.velocity()(2) << ", energy=" << backCell.energy() << std::endl;
          std::cout << "front: density=" << frontCell.density() << ", momentum=" << frontCell.velocity()(0) << "," << frontCell.velocity()(1) << "," << frontCell.velocity()(2) << ", energy=" << frontCell.energy() << std::endl;
          std::cout << "center: density=" << centerCell.density() << ", momentum=" << centerCell.velocity()(0) << "," << centerCell.velocity()(1) << "," << centerCell.velocity()(2) << ", energy=" << centerCell.energy() << std::endl;
        }
