...
tarch::logging::Log peanoclaw::pyclaw::NumericsFactory::_log("peanoclaw::pyclaw::NumericsFactory");

peanoclaw::Numerics* peanoclaw::pyclaw::NumericsFactory::createPyClawNumerics(
