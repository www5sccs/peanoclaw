...
#ifndef PEANOCLAW_ADAPTERS_InitialiseGrid_H_
#define PEANOCLAW_ADAPTERS_InitialiseGrid_H_
 ...
 */
class peanoclaw::adapters::InitialiseGrid {
  private:
  ...
  public:
    ...
    InitialiseGrid(const InitialiseGrid& masterThread);
    #endif

    virtual ~InitialiseGrid();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const InitialiseGrid& workerThread);
    #endif
