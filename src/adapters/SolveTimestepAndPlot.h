...
#ifndef PEANOCLAW_ADAPTERS_SolveTimestepAndPlot_H_
#define PEANOCLAW_ADAPTERS_SolveTimestepAndPlot_H_
 ...
 */
class peanoclaw::adapters::SolveTimestepAndPlot {
  private:
  ...
  public:
    ...
    SolveTimestepAndPlot();

    #if defined(SharedMemoryParallelisation)
    SolveTimestepAndPlot(const SolveTimestepAndPlot& masterThread);
    #endif

    virtual ~SolveTimestepAndPlot();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const SolveTimestepAndPlot& workerThread);
    #endif
