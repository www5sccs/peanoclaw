...
tarch::logging::Log peanoclaw::GridLevelTransfer::_log("peanoclaw::GridLevelTransfer");

void peanoclaw::GridLevelTransfer::vetoCoarseningIfNecessary (
  Patch&                                                      finePatch,
...
peanoclaw::GridLevelTransfer::GridLevelTransfer(
...
void peanoclaw::GridLevelTransfer::stepDown(
...
void peanoclaw::GridLevelTransfer::stepUp(
  int                                                         coarseCellDescriptionIndex,
  Patch&                                                      finePatch,
...
void peanoclaw::GridLevelTransfer::fillAdjacentPatchIndicesFromCoarseVertices(
...
void peanoclaw::GridLevelTransfer::restrictRefinementFlagsToCoarseVertices(
